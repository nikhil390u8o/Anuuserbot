...
async def mute_handle(client, event):
    ...
    await mute_user(client, event, value, reason)





async def mute_user(client, event, user, reason):
    ...
    try:
        ...
        if "Chat admin privilege" in e:
            ...
            await event.edit("Nope, I can't mute an admin.")   
...
async def unmute_handle(client, event):
    ...
    await unmute_user(client, event, value, reason)





async def unmute_user(client, event, user, reason):
    rights = ChatBannedRights(
    until_date=None,
    send_messages=False,
    send_media=False,
    ...
    try:
        ...
        if "Chat admin privilege" in e:
            ...
            await event.edit("Nope, I can't unmute an admin.")   
